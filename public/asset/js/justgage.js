...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Poppins"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#ff0000"], 'array', ','),

    // startAnimationTime : int
    // length of initial animation
    startAnimationTime: kvLookup('startAnimationTime', config, dataset, 1200),

    // startAnimationType : string
    // type of initial animation (linear, >, <,  <>, bounce)
    startAnimationType: kvLookup('startAnimationType', config, dataset, 'linear'),
    ...
    valueMinFontSize: kvLookup('valueMinFontSize', config, dataset, 13),
