	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			...
			{
				type_point: 'Pub - Cocktails',
				location_latitude: 43.768518, 
				location_longitude: 11.255539,
				map_image_url: 'img/thumb_map_bar_3.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Francis Bar',
			...
			{
				type_point: 'Coffee Bar',
				location_latitude: 43.769566, 
				location_longitude: 11.256114,
				map_image_url: 'img/thumb_map_bar_4.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Visconti Bar',
				description_point: 'Piazza di S. Maria Novella, Florence',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_detail: 'florence-bar-detail.html'
			},
			{
				...
				map_image_url: 'img/thumb_map_bar_5.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Florence Mojito',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_bar_6.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Alfredo Pub',
			...
			{
				type_point: 'Coffee - Pub',
				location_latitude: 43.769560, 
				location_longitude: 11.255814,
				map_image_url: 'img/thumb_map_bar_7.jpg',
				rate: 'Superb | 7.5',
			...
			},
			{
				...
				location_latitude: 43.769560, 
				location_longitude: 11.255814,
				map_image_url: 'img/thumb_map_bar_8.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Domenico',
				description_point: 'Palazzo Strozzi 9, Florence',
				get_directions_start_address: '',
