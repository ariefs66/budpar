	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_restaurant_2.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Catrine',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_restaurant_3.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Florence Pizza',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_restaurant_4.jpg',
				rate: 'Superb | 7.5',
				name_point: 'La Bruschetteria',
				description_point: 'Piazza di S. Maria Novella, Florence',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_detail: 'florence-restaurant-detail.html'
			},
			{
				...
				map_image_url: 'img/thumb_map_restaurant_5.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Sea Food',
			...
			{
				type_point: 'International',
				location_latitude: 43.772840, 
				location_longitude: 11.257929,
				map_image_url: 'img/thumb_map_restaurant_6.jpg',
				rate: 'Superb | 7.5',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_restaurant_7.jpg',
				rate: 'Superb | 7.5',
